...
// Запрашиваем "репосты+шеры" и "просмотры" отдельными вызовами, чтобы сбой
// одной метрики (например, views недоступен для конкретного типа медиа)
// не обнулял остальные. Ошибки выводим в лог Vercel, а не прячем молча.
